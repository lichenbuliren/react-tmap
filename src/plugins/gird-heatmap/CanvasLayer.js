 ...
 */
  ...
  CanvasLayer.prototype.onAdd = function () {
    ...
    this.resizeListener_ = qq.maps.event.addListener(this.getMap(), 'resize', this.resizeFunction_)
    this.centerListener_ = qq.maps.event.addListener(this.getMap(), 'center_changed', this.repositionFunction_)
  ...
  CanvasLayer.prototype.repositionCanvas_ = function () {
    ...
    var top = map.getBounds().getNorthEast().getLat()
